...
/* WEBPACK VAR INJECTION */(function($) {document.querySelectorAll('a[href^="#"]').forEach(function (anchor) {
...
$(function () {
    $('#loadMore').click(function () {
        ...
        $.ajax({
            url: '/projet6/public/index.php/loadMore',
            type: 'GET',
            data: {
