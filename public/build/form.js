...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/form.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* WEBPACK VAR INJECTION */(function($) {$(document).ready(function () {
    ...
    function addMediaForm($container) {
        try {
            var template = $container.attr('data-prototype').replace("__name__label__", '').replace("[__name__]", '[' + index + ']').replace("[__name__]", '[' + index + ']');
...
$(document).ready(function () {
    ...
    function addVideoForm($container) {
        try {
            var template = $container.attr('data-prototype').replace("__name__label__", '').replace("trick_videos___name__", 'trick_videos_' + index).replace("trick_videos___name___url", 'trick_videos_url" placeholder="Url"' + index).replace("[__name__]", '[' + index + ']').replace("[__name__]", '[' + index + ']');
